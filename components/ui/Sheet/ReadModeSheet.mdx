...
<Meta title="Displays/Sheet/Read-Mode Sheet" />

# Read-Mode Sheet

The narrow-view sibling of [Displays / Form / Read-Mode Page](?path=/docs/displays-form-read-mode-page--docs). Where a page surfaces an entire record at once, a sheet surfaces **one facet** of it — a focused slice with its own view + edit lifecycle.
...
- [Displays / Form / Read-Mode Page](?path=/docs/displays-form-read-mode-page--docs) — the page-wide sibling of this pattern.
