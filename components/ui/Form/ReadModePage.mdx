...
<Meta title="Displays/Form/Read-Mode Page" />
...
- [Displays / Sheet / Read-Mode Sheet](?path=/docs/displays-sheet-read-mode-sheet--docs) — the narrow-view sibling of this pattern, for focused sheet overlays.
