...
This is one of four product page archetypes. The index — and the rule for picking between them — lives at [Build Standards → Page Archetypes](https://design.brikdesigns.com/docs/build-standards/page-archetypes); the decision page for this one is [Record Read](https://design.brikdesigns.com/docs/build-standards/page-archetypes/record-read). **This page owns the live canvases and the two section-level edit conventions below**; the docs-site page owns which archetype a surface gets.
...
`PageHeader.mode` is symmetric with [`Sheet.mode`](?path=/docs/containers-sheet--docs) — see [`PageHeader`](?path=/docs/sections-page-header--docs) for the full API. Pair this with the [footer-driven navigation](https://design.brikdesigns.com/docs/components/sheet#footer-driven-navigation) convention (`Sheet.viewDetailsAction` + `editTarget="page"`) when a table row opens a snapshot sheet that links to the read/edit pages.
...
- [Page Archetypes](https://design.brikdesigns.com/docs/build-standards/page-archetypes) — the index for all four product page archetypes, and the rule for picking one.
- [Record Edit](https://design.brikdesigns.com/docs/build-standards/page-archetypes/record-edit) — the page-level edit half, when the whole record edits at once instead of per section.
- [Collection](https://design.brikdesigns.com/docs/build-standards/page-archetypes/collection) — the archetype for many peer records behind a control bar.
- [Profile](https://design.brikdesigns.com/docs/build-standards/page-archetypes/profile) — this archetype as one tab of a tabbed entity page.
- [Composing a read-mode sheet](https://design.brikdesigns.com/docs/components/sheet#composing-a-read-mode-sheet) — the narrow-view sibling of this pattern, for focused sheet overlays.
