...
- **Visual regression** — self-hosted Vitest `toMatchScreenshot` in the `storybook` project, blocking in [`test.yml`](.github/workflows/test.yml) (ADR-026 Arm B, #1637). Until #1637 lands there is **no automated visual gate**; verify pixel-affecting changes by hand.
