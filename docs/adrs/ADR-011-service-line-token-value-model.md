...
**Related:** [#563](https://github.com/brikdesigns/brik-bds/issues/563) (service-token reconciliation), [#564](https://github.com/brikdesigns/brik-bds/issues/564) (token-name anatomy — naming formula now in [token-anatomy](../../docs-site/content/docs/foundation/token-anatomy.mdx) via [#809](https://github.com/brikdesigns/brik-bds/pull/809)), [#761](https://github.com/brikdesigns/brik-bds/issues/761) (Brand Kit semantic audit), [Figma Library Architecture](../../docs-site/content/docs/getting-started/figma-library-architecture.mdx)
