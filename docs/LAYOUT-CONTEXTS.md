...
Companion to [`.claude/standards/component-build.md`](../.claude/standards/component-build.md) and the canonical [Primitives](https://design.brikdesigns.com/docs/foundation) registry. Every token referenced here is defined in [`tokens/figma-tokens.css`](../tokens/figma-tokens.css).
