...
<Meta title="Foundations/Content System/Voices/Overview" />
...
- [Vocabularies](?path=/docs/foundations-content-system-vocabularies--docs)
- [Industries](?path=/docs/foundations-content-system-industries-dental--docs)
