...
<Meta title="Foundations/Content/Industries/Dental" />
...
Structured data lives in [`dental.ts`](?path=/docs/foundations-content-industries-dental--docs). This page is the narrative companion. Keep them in sync.
...
- [Blueprint library](?path=/docs/overview-theming-blueprints--docs) — page layout patterns tagged with industry affinities
- [Vocabularies](?path=/docs/foundations-content-vocabularies--docs) — locked enums for Personality, Voice, Visual Style
