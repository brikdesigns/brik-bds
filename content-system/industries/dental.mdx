...
<Meta title="Foundations/Content System/Industries/Dental" />
...
Structured data lives in [`dental.ts`](?path=/docs/foundations-content-system-industries-dental--docs). This page is the narrative companion. Keep them in sync.
...
- [Blueprint library](?path=/docs/foundations-content-system-blueprints--docs) — page layout patterns tagged with industry affinities
- [Vocabularies](?path=/docs/foundations-content-system-vocabularies--docs) — locked enums for Personality, Voice, Visual Style
