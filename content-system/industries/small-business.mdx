...
Structured data lives in [`small-business.ts`](?path=/docs/content-industries-small-business-general---docs). Promotion rules at the bottom of this page govern when to graduate a vertical out of this pack.
...
1. Add the new slug to [`vocabularies/industry.ts`](?path=/docs/content-vocabularies-image-mood--docs).
...
- [Dental pack](?path=/docs/content-industries-dental--docs) — first graduated vertical, reference for pack structure
- [Vocabularies](?path=/docs/content-vocabularies-image-mood--docs) — locked enums
