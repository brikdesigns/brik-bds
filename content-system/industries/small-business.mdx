...
<Meta title="Foundations/Content/Industries/Small Business (General)" />
...
Structured data lives in [`small-business.ts`](?path=/docs/foundations-content-industries-small-business--docs). Promotion rules at the bottom of this page govern when to graduate a vertical out of this pack.
...
1. Add the new slug to [`vocabularies/industry.ts`](?path=/docs/foundations-content-vocabularies--docs).
...
- [Dental pack](?path=/docs/foundations-content-industries-dental--docs) — first graduated vertical, reference for pack structure
- [Vocabularies](?path=/docs/foundations-content-vocabularies--docs) — locked enums
