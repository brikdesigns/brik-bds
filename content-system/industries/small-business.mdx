...
<Meta title="Foundations/Content System/Industries/Small Business (General)" />
...
Structured data lives in [`small-business.ts`](?path=/docs/foundations-content-system-industries-small-business--docs). Promotion rules at the bottom of this page govern when to graduate a vertical out of this pack.
...
1. Add the new slug to [`vocabularies/industry.ts`](?path=/docs/foundations-content-system-vocabularies--docs).
...
- [Dental pack](?path=/docs/foundations-content-system-industries-dental--docs) — first graduated vertical, reference for pack structure
- [Vocabularies](?path=/docs/foundations-content-system-vocabularies--docs) — locked enums
