...
<Meta title="Foundations/Content/Industries/Real Estate" />

# Real Estate

**Version:** {realEstateRvMhc.version}  •  **Last reviewed:** {realEstateRvMhc.lastReviewed}  •  **Review cadence:** {realEstateRvMhc.reviewCadence}

Structured data lives in [`real-estate-rv-mhc.ts`](?path=/docs/foundations-content-industries-real-estate--docs). This page is the narrative companion.
...
- [Dental pack](?path=/docs/foundations-content-industries-dental--docs) — reference for pack structure maturity
- [Small Business baseline](?path=/docs/foundations-content-industries-small-business-general---docs) — catch-all pack
