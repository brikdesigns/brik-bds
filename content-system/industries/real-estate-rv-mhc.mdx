...
<Meta title="Foundations/Content System/Industries/Real Estate" />

# Real Estate

**Version:** {realEstateRvMhc.version}  •  **Last reviewed:** {realEstateRvMhc.lastReviewed}  •  **Review cadence:** {realEstateRvMhc.reviewCadence}

Structured data lives in [`real-estate-rv-mhc.ts`](?path=/docs/foundations-content-system-industries-real-estate--docs). This page is the narrative companion.
...
- [Dental pack](?path=/docs/foundations-content-system-industries-dental--docs) — reference for pack structure maturity
- [Small Business baseline](?path=/docs/foundations-content-system-industries-small-business-general---docs) — catch-all pack
