...
- [Atmospheres](?path=/docs/theming-layers-atmospheres--docs) — mood overlays, full vocabulary, per-atmosphere previews
- [Navigation Archetypes](?path=/docs/theming-layers-navigation-archetypes--docs) — site-header patterns with per-industry defaults
- [Blueprints](?path=/docs/theming-layers-blueprints--docs) — section composition tagged by mood + industry
...
- [Atmospheres](?path=/docs/theming-layers-atmospheres--docs) — mood overlay selected per industry pack
- [Navigation Archetypes](?path=/docs/theming-layers-navigation-archetypes--docs) — site-header pattern selected per industry pack
- [Design Tokens overview](?path=/docs/foundations-design-tokens-overview--docs)
- [Client Theming](?path=/docs/theming-layers-client-themes--docs)
