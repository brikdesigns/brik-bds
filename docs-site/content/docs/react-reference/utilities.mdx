...
See [Token Anatomy](/docs/foundation/token-anatomy) for the four-tier abstraction this pipeline emits, [Library architecture](/docs/getting-started/figma-library-architecture) for the per-Library detail, and [The cascade](/docs/getting-started/cascade) for how the CSS output composes at runtime.
...
- [Primitives → Color](/docs/foundation/color) — canonical token registry the build pipeline emits
