...
Use [Layout primitives](/docs/composition-layers#the-five-layers) — `Stack`, `Cluster`, `Grid`, `Split`, `Row` — to arrange blocks inside `__content`. Do not hand-roll flex/grid in section CSS when a layout primitive covers the case.
