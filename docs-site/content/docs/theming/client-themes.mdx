...
| Non-valence hues (`--background-accent-purple/orange`) | **No** | Figma-sourced from the system color primitives. The hue-source scope, not a valence — see [Accent](/docs/primitives/color#accent). |
