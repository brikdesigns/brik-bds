...
|---|---|---|
| Background | `--background-{role}` | `--background-brand-primary`, `--background-primary-hover`, `--background-status-info` |
| Text | `--text-{role}` | `--text-primary`, `--text-brand-primary`, `--text-status-info` |
| Surface | `--surface-{role}` | `--surface-primary`, `--surface-secondary`, `--surface-status-info` |
