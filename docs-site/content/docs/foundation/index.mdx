...
<Cards>
  ...
  <Card title="Border radius" href="/docs/foundation/border-radius" description="Corner rounding from sharp (0) to pill (999) to fully circular." />
  <Card title="Border width" href="/docs/foundation/border-width" description="Line thickness for borders, dividers, and outlines." />
  <Card title="Shadow" href="/docs/foundation/shadow" description="Elevation tokens — composed semantic shadows + primitive blur/spread scales." />
