...
- [Layout Archetypes](/docs/theming/layout-archetypes) — site-header and site-footer pattern vocabularies with per-industry defaults
...
- [Layout Archetypes](/docs/theming/layout-archetypes) — site-header and site-footer patterns selected per industry pack
