...
|---|---|
| **Home** | `hero_split` → `two_column_detail` → `story_split` → `testimonials_featured_large` → `cta_split_contact` |
| **About** | `hero_interior_minimal` → `story_split` → `cta_centered` |
| **Services** | `hero_interior_minimal` → `two_column_detail` → `cta_centered` |
| **Contact** | `hero_interior_minimal` → `cta_split_contact` |
| **Testimonials** | `hero_interior_minimal` → `testimonials_featured_large` → `cta_centered` |
| **Pricing** | `hero_interior_minimal` → `two_column_detail` → `cta_centered` |
| **Service Areas** | `hero_interior_minimal` → `story_split` → `cta_centered` |
