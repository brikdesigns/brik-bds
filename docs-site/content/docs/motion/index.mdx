...
- [Motion tokens](/docs/primitives/motion) — the `--duration-*`, `--ease-*`, and `--stagger-*` scales, and why the numeric duration suffix is a step index rather than a millisecond value
