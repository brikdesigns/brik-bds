---
title: GSAP
description: Adds scroll choreography — pinning, scrubbing, horizontal scroll, SplitText. Loads when the design needs runtime control on top of CSS effects.
---
