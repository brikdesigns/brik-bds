---
title: Overlays
description: Atmosphere overlays — film grain and glassmorphism. ::after pseudo-elements; no additional DOM nodes required. Premium tier.
---
...
<Callout type="warn">
  **Performance:** `.grain-overlay--animated` triggers a continuous CSS animation. Use sparingly — one animated grain section per page is the maximum. Prefer the static variant on interior sections.
</Callout>
...
- [Atmospheres](/docs/theming/atmospheres) — Premium overlays compose into atmosphere CSS files
- [Motion Overview](/docs/motion)
