...
| Tenet | Answers | Ships |
|---|---|---|
| [**Foundation**](/docs/foundation) | *"What color, size, type?"* | Design tokens, scales, primitives |
...
<Cards>
  ...
  <Card title="Foundation" href="/docs/foundation" description="Design tokens — color, type, spacing, radius, shadow." />
