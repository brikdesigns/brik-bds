...
{/* props-check: ToastProps @ components/ui/Toast/Toast.tsx */}
...
|---|---|---|
| `--bds-toast-shadow` | `0px 4px 12px 4px rgba(0,0,0,0.24)` | Elevation shadow |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-toast--overview)**
