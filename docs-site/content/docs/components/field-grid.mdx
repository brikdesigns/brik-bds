...
{/* props-check: FieldGridProps @ components/ui/FieldGrid/FieldGrid.tsx */}
| Prop | Type | Default |
|---|---|---|
| `columns` | `FieldGridColumns` | `2` |
| `gap` | `FieldGridGap` | `'lg'` |
| `children` | `ReactNode` | — |
...
- [Card](/docs/components/card) — wrap each cell to get stat-tile styling
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-field-grid--overview)**
