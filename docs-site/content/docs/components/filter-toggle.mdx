...
{/* props-check: FilterToggleProps @ components/ui/FilterToggle/FilterToggle.tsx */}
...
- [Toggle Switch](/docs/components/toggle-switch) — for non-filter boolean toggles (settings, preferences)
