...
{/* props-check: EmptyStateProps @ components/ui/EmptyState/EmptyState.tsx */}
| Prop | Type | Default |
|---|---|---|
| `title` | `string` *(required)* | — |
| `description` | `string` | — |
| `buttonProps` | `{ children: ReactNode; onClick?: MouseEventHandler<HTMLButtonElement>; iconBefore?: ReactNode; iconAfter?: ReactNode; }` | — |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-empty-state--overview)**
