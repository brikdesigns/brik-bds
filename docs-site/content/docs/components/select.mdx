...
- **Don't use Select for ≤3 options.** Use [Radio](/docs/components/radio) (vertical) or [SegmentedControl](https://storybook.brikdesigns.com/?path=/docs/components-segmented-control--overview) (horizontal) — both surface choices visibly.
