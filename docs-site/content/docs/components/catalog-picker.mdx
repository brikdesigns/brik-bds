...
{/* props-check: CatalogPickerProps @ components/ui/CatalogPicker/CatalogPicker.tsx */}
| Prop | Type | Default |
|---|---|---|
...
re-exported from this module as `CatalogPickerSize`.
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/containers-catalog-picker--overview)**
