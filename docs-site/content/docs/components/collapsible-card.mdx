...
description: DEPRECATED — use Collapsible instead.
---

import { Callout } from 'fumadocs-ui/components/callout';

<Callout type="warn">
  **CollapsibleCard is deprecated.** Migrate to [`Collapsible`](https://storybook.brikdesigns.com/?path=/docs/components-collapsible--overview) ([#701](https://github.com/brikdesigns/brik-bds/issues/701)) — the Radix-backed successor with identical props. The import path is unchanged until removal in a future major version.
</Callout>

## Migration

Same props, same defaults, same behavior — the component was renamed onto a Radix primitive. Swap the name (and the import); nothing else changes.
...
<Collapsible sectionLabel="Section 01" title="Overview and Goals">
  <p>Content goes here…</p>
</Collapsible>
```

Every prop (`title`, `children`, `sectionLabel`, `isOpen`, `onOpenChange`, `defaultOpen`, `headerActions`) carries over unchanged. See the [Collapsible Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-collapsible--overview) for the current component.

---

The reference below documents the frozen CollapsibleCard API for migration. New code should use [Collapsible](https://storybook.brikdesigns.com/?path=/docs/components-collapsible--overview).
...
{/* props-check: CollapsibleCardProps @ components/ui/CollapsibleCard/CollapsibleCard.tsx */}
| Prop | Type | Default |
|---|---|---|
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/deprecated-collapsible-card--overview)**
