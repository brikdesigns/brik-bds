...
<Callout type="warn">
  **CollapsibleCard is deprecated.** Migrate to [`Collapsible`](https://storybook.brikdesigns.com/?path=/docs/containers-collapsible--overview) ([#701](https://github.com/brikdesigns/brik-bds/issues/701)) — the Radix-backed successor with identical props. The import path is unchanged until removal in a future major version.
</Callout>
...
Every prop (`title`, `children`, `sectionLabel`, `isOpen`, `onOpenChange`, `defaultOpen`, `headerActions`) carries over unchanged. See the [Collapsible Storybook playground](https://storybook.brikdesigns.com/?path=/docs/containers-collapsible--overview) for the current component.

---

The reference below documents the frozen CollapsibleCard API for migration. New code should use [Collapsible](https://storybook.brikdesigns.com/?path=/docs/containers-collapsible--overview).
