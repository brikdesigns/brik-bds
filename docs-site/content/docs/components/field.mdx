...
```tsx
<Field orientation="horizontal" label="Scraped">8</Field>
<Field orientation="horizontal" label="Status">Active</Field>
```
...
{/* props-check: FieldProps @ components/ui/Field/Field.tsx */}
...
| `tier` | `FieldTier` | — |
| `helper` | `ReactNode` | — |
| `helperTone` | `FieldHelperTone` | `'neutral'` |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-field--overview)**
