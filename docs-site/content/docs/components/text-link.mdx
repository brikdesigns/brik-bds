...
{/* props-check: TextLinkProps @ components/ui/TextLink/TextLink.tsx */}
...
| `iconAfter` | `ReactNode` | — |
| `emphasis` | `TextLinkEmphasis` | `'brand'` |
| `tone` | `TextLinkEmphasis` | — |
| `underline` | `TextLinkUnderline` | `'hover'` |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-text-link--overview)**
