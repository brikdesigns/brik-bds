...
{/* props-check: ModalProps @ components/ui/Modal/Modal.tsx */}
| Prop | Type | Default |
|---|---|---|
...
| `confirmVariant` | `ModalConfirmVariant` | `'primary'` |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-modal--overview)**
