...
- **Don't use Skeleton in places the final content might be empty.** "No results" is a different state than "loading"; use [EmptyState](/docs/components/empty-state) once the load resolves.
...
{/* props-check: SkeletonProps @ components/ui/Skeleton/Skeleton.tsx */}
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-skeleton--overview)**
