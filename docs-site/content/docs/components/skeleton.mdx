...
- **Don't use Skeleton in places the final content might be empty.** "No results" is a different state than "loading"; use [EmptyState](https://storybook.brikdesigns.com/?path=/docs/components-empty-state--overview) once the load resolves.
