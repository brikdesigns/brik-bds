...
<ComparisonGrid
  items={[
    {
      title: 'Badge',
      preview: <BDS.Badge tone="positive">Done</BDS.Badge>,
      ...
      code: `<Badge tone="positive">Done</Badge>`,
    },
    {
      title: 'Tag',
...
<ComponentPreview code={`<BDS.Badge tone="positive">Done</BDS.Badge>
<BDS.Badge tone="warning">Pending</BDS.Badge>
<BDS.Badge tone="negative">Failed</BDS.Badge>
<BDS.Badge tone="info">Note</BDS.Badge>
<BDS.Badge tone="info">In progress</BDS.Badge>
<BDS.Badge tone="brand">Featured</BDS.Badge>`}>
  <BDS.Badge tone="positive">Done</BDS.Badge>
  <BDS.Badge tone="warning">Pending</BDS.Badge>
  <BDS.Badge tone="negative">Failed</BDS.Badge>
  <BDS.Badge tone="info">Note</BDS.Badge>
  <BDS.Badge tone="info">In progress</BDS.Badge>
...
<ComponentPreview code={`<BDS.Badge tone="positive" appearance="subtle">Done</BDS.Badge>
<BDS.Badge tone="info" appearance="subtle">In progress</BDS.Badge>`}>
  <BDS.Badge tone="positive" appearance="subtle">Done</BDS.Badge>
  <BDS.Badge tone="info" appearance="subtle">In progress</BDS.Badge>
</ComponentPreview>
...
<ComponentPreview code={`<BDS.Badge size="sm" tone="positive">Done</BDS.Badge>
<BDS.Badge size="md" tone="positive">Done</BDS.Badge>
<BDS.Badge size="lg" tone="positive">Done</BDS.Badge>`}>
  <BDS.Badge size="sm" tone="positive">Done</BDS.Badge>
  <BDS.Badge size="md" tone="positive">Done</BDS.Badge>
  <BDS.Badge size="lg" tone="positive">Done</BDS.Badge>
</ComponentPreview>
...
```tsx
<Badge tone="positive" icon={<CheckIcon />}>Done</Badge>
<Badge size="xs" tone="negative" icon={<XCircleIcon />} />
```
...
{/* props-check: BadgeProps @ components/ui/Badge/Badge.tsx */}
| Prop | Type | Default |
|---|---|---|
| `tone` | `BadgeTone` | `'info'` |
| `status` | `BadgeTone` | — |
| `size` | `BadgeSize` | `'md'` |
| `appearance` | `BadgeAppearance` | `'solid'` |
| `icon` | `ReactNode` | — |
| `children` | `ReactNode` | — |
| `density` | `BadgeDensity` | `'comfortable'` |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-badge--overview)**
