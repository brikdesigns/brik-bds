...
{/* props-check: NotificationListProps @ components/ui/NotificationList/NotificationList.tsx */}
| Prop | Type | Default |
|---|---|---|
| `notifications` | `NotificationItemData[]` *(required)* | — |
| `onItemClick` | `(notification: NotificationItemData) => void` | — |
| `emptyMessage` | `string` | `'No notifications yet'` |
| `className` | `string` | — |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/story/containers-notification-list--default)**
