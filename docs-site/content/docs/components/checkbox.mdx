...
For status toggling (on/off settings), use [Switch](https://storybook.brikdesigns.com/?path=/docs/components-switch--overview) — it carries the right semantic for "this preference is now active" vs "I am picking this option."
...
- **Don't use Checkbox for on/off preferences.** Use [Switch](https://storybook.brikdesigns.com/?path=/docs/components-switch--overview) — the affordance is correct for "now active" semantics.
...
- [Switch](https://storybook.brikdesigns.com/?path=/docs/components-switch--overview) — for on/off preferences
