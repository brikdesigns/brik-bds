...
For status toggling (on/off settings), use [Switch](/docs/components/switch) — it carries the right semantic for "this preference is now active" vs "I am picking this option."
...
- **Don't use Checkbox for on/off preferences.** Use [Switch](/docs/components/switch) — the affordance is correct for "now active" semantics.
...
- [Switch](/docs/components/switch) — for on/off preferences
