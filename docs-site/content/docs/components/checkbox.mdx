...
For status toggling (on/off settings), use [Toggle Switch](/docs/components/toggle-switch) — it carries the right semantic for "this preference is now active" vs "I am picking this option."
...
- **Don't use Checkbox for on/off preferences.** Use [Toggle Switch](/docs/components/toggle-switch) — the affordance is correct for "now active" semantics.
...
{/* props-check: CheckboxProps @ components/ui/Checkbox/Checkbox.tsx */}
...
- [Toggle Switch](/docs/components/toggle-switch) — for on/off preferences
- [Checklist](/docs/components/checklist) — for *completion* (task done), not selection
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-checkbox--overview)**
