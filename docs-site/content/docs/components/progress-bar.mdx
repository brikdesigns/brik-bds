...
{/* props-check: ProgressBarProps @ components/ui/ProgressBar/ProgressBar.tsx */}
| Prop | Type | Default |
|---|---|---|
...
- [ProgressCircle](/docs/components/progress-circle) — same progress value, drawn as a ring
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-progress-bar--overview)**
