...
{/* props-check: DataSectionProps @ components/ui/DataSection/DataSection.tsx */}
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/containers-data-section--overview)**
