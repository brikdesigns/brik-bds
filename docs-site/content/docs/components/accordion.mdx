...
{/* props-check: AccordionProps @ components/ui/Accordion/Accordion.tsx */}
| Prop | Type | Default |
|---|---|---|
...
| `hideSubtitleWhenOpen` | `boolean` | `false` |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/containers-accordion--overview)**
- [TabBar](/docs/components/tab-bar) — the peer-category sibling; tabs when the set is options to pick between, not steps to walk through
