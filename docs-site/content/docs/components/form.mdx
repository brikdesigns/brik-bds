...
```tsx
<Form orientation="horizontal" {...props}>
...
{/* props-check: FormProps @ components/ui/Form/Form.tsx */}
| Prop | Type | Default |
|---|---|---|
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/forms-form--overview)**
