...
- **Don't use it for a single on/off setting.** A lone preference toggle is a [Switch](/docs/components/switch).
...
- [Switch](/docs/components/switch) — single on/off setting
