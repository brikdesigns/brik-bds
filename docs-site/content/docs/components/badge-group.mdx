...
{/* props-check: BadgeGroupProps @ components/ui/BadgeGroup/BadgeGroup.tsx */}
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-badge-group--overview)**
