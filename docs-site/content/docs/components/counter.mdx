...
<ComponentPreview code={`<BDS.Counter count={5} tone="positive" />
<BDS.Counter count={3} tone="negative" />
<BDS.Counter count={2} tone="warning" />
<BDS.Counter count={7} tone="info" />
<BDS.Counter count={4} tone="brand" />
<BDS.Counter count={9} tone="neutral" />`}>
  <BDS.Counter count={5} tone="positive" />
  <BDS.Counter count={3} tone="negative" />
  <BDS.Counter count={2} tone="warning" />
  <BDS.Counter count={7} tone="info" />
  <BDS.Counter count={4} tone="brand" />
...
<ComponentPreview code={`<BDS.Counter count={3} size="xs" tone="negative" />
<BDS.Counter count={3} size="sm" tone="negative" />
<BDS.Counter count={3} size="md" tone="negative" />
<BDS.Counter count={3} size="lg" tone="negative" />`}>
  <BDS.Counter count={3} size="xs" tone="negative" />
  <BDS.Counter count={3} size="sm" tone="negative" />
  <BDS.Counter count={3} size="md" tone="negative" />
  <BDS.Counter count={3} size="lg" tone="negative" />
</ComponentPreview>
...
<ComponentPreview code={`<BDS.Counter count={150} max={99} tone="brand" />
<BDS.Counter count={9} max={99} tone="brand" />`}>
  <BDS.Counter count={150} max={99} tone="brand" />
  <BDS.Counter count={9} max={99} tone="brand" />
</ComponentPreview>
...
{/* props-check: CounterProps @ components/ui/Counter/Counter.tsx */}
| Prop | Type | Default |
|---|---|---|
| `count` | `number` *(required)* | — |
| `tone` | `CounterTone` | `'positive'` |
| `status` | `CounterTone` | `'success'` |
| `size` | `CounterSize` | `'sm'` |
| `max` | `number` | — |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-counter--overview)**
