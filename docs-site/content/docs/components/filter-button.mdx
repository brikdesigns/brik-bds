...
- **Don't use for multi-select.** This component is single-select only. For multi-select, use a checkbox menu inside a Popover or a [MultiSelect](https://storybook.brikdesigns.com/?path=/docs/components-multi-select--overview).
