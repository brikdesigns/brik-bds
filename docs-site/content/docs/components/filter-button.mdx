...
- **Don't use for multi-select.** This component is single-select only. For multi-select, use a checkbox menu inside a Popover or a [MultiSelect](/docs/components/multi-select).
...
{/* props-check: FilterButtonProps @ components/ui/FilterButton/FilterButton.tsx */}
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-filter-button--overview)**
