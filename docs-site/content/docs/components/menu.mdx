...
{/* props-check: MenuProps @ components/ui/Menu/Menu.tsx */}
| Prop | Type | Default |
|---|---|---|
| `items` | `(MenuItemData \| MenuItemGroup)[]` *(required)* | — |
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/containers-menu--overview)**
