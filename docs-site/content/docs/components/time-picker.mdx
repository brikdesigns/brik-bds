...
{/* props-check: TimePickerProps @ components/ui/TimePicker/TimePicker.tsx */}
| Prop | Type | Default |
|---|---|---|
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/components-time-picker--overview)**
