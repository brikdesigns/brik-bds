...
{/* props-check: BoardProps @ components/ui/Board/Board.tsx */}
| Prop | Type | Default |
|---|---|---|
...
{/* props-check: BoardColumnProps @ components/ui/Board/BoardColumn.tsx */}
| Prop | Type | Default |
|---|---|---|
...
{/* props-check: BoardHeaderProps @ components/ui/Board/BoardHeader.tsx */}
| Prop | Type | Default |
|---|---|---|
...
- **[Storybook playground](https://storybook.brikdesigns.com/?path=/docs/containers-board--overview)**
