 ...
 * `registerClientTheme`.
 */
export declare const BUILT_IN_THEMES: readonly ThemeSpec[];
/**
 ...
 */
export declare function registerClientTheme(spec: ThemeSpec): void;
/**
 ...
 */
export declare function getAllThemes(): readonly ThemeSpec[];
/**
 ...
 */
export declare function _resetClientThemesForTests(): void;
