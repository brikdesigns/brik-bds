 ...
 */
export declare const SHORTLIST_WEIGHTS: {
    readonly perPersonalityHit: 2;
    readonly perVisualStyleHit: 1;
    readonly industrySlugMatch: 3;
    readonly universalBonus: 5;
};
 ...
 */
export declare function scoreBlueprintForProfile(blueprint: NormalizedBlueprint, profile: BlueprintShortlistProfile): BlueprintShortlistEntry;
/**
 ...
 */
export declare function resolveBlueprintShortlist(profile: BlueprintShortlistProfile, library: readonly NormalizedBlueprint[], options?: ResolveBlueprintShortlistOptions): readonly NormalizedBlueprint[];
/**
 ...
 */
export declare function resolveBlueprintShortlistWithScores(profile: BlueprintShortlistProfile, library: readonly NormalizedBlueprint[], options?: ResolveBlueprintShortlistOptions): readonly BlueprintShortlistEntry[];
