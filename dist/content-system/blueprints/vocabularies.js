...
export const isMood = (value) => MOOD_VALUES.includes(value);
/**
...
export const isIndustryTag = (value) => INDUSTRY_TAG_VALUES.includes(value);
/**
...
export const isSectionType = (value) => SECTION_TYPE_VALUES.includes(value);
/**
...
export const isPatternType = (value) => PATTERN_TYPE_VALUES.includes(value);
/**
 ...
 */
export const BLUEPRINT_TIER_VALUES = ['internal', 'template'];
export const isBlueprintTier = (value) => BLUEPRINT_TIER_VALUES.includes(value);
