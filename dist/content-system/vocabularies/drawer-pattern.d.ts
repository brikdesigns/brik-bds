 ...
 *     as a search surface.
 */
export declare const DRAWER_PATTERN_VALUES: readonly ["fullscreen-overlay", "slide-left-panel", "bottom-sheet"];
export type DrawerPattern = (typeof DRAWER_PATTERN_VALUES)[number];
export declare const isDrawerPattern: (value: string) => value is DrawerPattern;
//# sourceMappingURL=drawer-pattern.d.ts.map