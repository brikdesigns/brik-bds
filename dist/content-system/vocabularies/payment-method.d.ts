 ...
 */
export declare const PAYMENT_METHOD_VALUES: readonly ["Cash", "Check", "Debit", "Visa", "Mastercard", "Amex", "Discover", "Apple Pay", "Google Pay", "ACH/Bank Transfer", "Venmo", "Zelle", "CareCredit", "HSA/FSA"];
export type PaymentMethod = (typeof PAYMENT_METHOD_VALUES)[number];
export declare const isPaymentMethod: (value: string) => value is PaymentMethod;
