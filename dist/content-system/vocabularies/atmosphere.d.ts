 ...
 */
export declare const ATMOSPHERE_VALUES: readonly ["editorial-luxury", "cinematic-dramatic", "minimal-clinical", "warm-soft", "clean-bright", "organic-textured", "none"];
export type Atmosphere = (typeof ATMOSPHERE_VALUES)[number];
export declare const isAtmosphere: (value: string) => value is Atmosphere;
/**
 ...
 */
export declare const THEME_MODE_VALUES: readonly ["light", "dark"];
export type ThemeMode = (typeof THEME_MODE_VALUES)[number];
export declare const isThemeMode: (value: string) => value is ThemeMode;
/**
 ...
 */
export declare const ATMOSPHERE_THEME_MODE: Record<Atmosphere, ThemeMode | null>;
