 ...
 */
export declare const NAV_ARCHETYPE_VALUES: readonly ["editorial-transparent", "utility-first", "service-centric", "portfolio-minimal", "calm-flat"];
export type NavArchetype = (typeof NAV_ARCHETYPE_VALUES)[number];
export declare const isNavArchetype: (value: string) => value is NavArchetype;
//# sourceMappingURL=nav-archetype.d.ts.map