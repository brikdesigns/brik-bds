 ...
 */
export declare const SCROLL_BEHAVIOR_VALUES: readonly ["transparent-top-frosted-past-80", "sticky-solid", "reveal-on-scroll", "hide-on-scroll"];
export type ScrollBehavior = (typeof SCROLL_BEHAVIOR_VALUES)[number];
export declare const isScrollBehavior: (value: string) => value is ScrollBehavior;
//# sourceMappingURL=scroll-behavior.d.ts.map