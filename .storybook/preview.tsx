    ...
    options: {
      storySort: {
        order: [
          ...
          'Components',
          ['button', 'button-group', 'text-link', 'filter-bar', 'filter-button', 'filter-toggle', 'text-input', 'text-area', 'select', 'multi-select', 'checkbox', 'radio', 'switch', 'slider', 'stepper', 'segmented-control', 'pagination', 'file-uploader', 'address-input', 'password-input', 'completion-toggle', 'badge', 'badge-group', 'chip', 'tag', 'tag-group', 'counter', 'dot', 'skeleton', 'spinner', 'service-tag', 'banner', 'toast', 'tooltip', 'empty-state', 'progress-bar', 'progress-circle', 'modal', 'popover', 'meter', 'divider', 'avatar', 'icons', 'marketing-illustration', '*'],
          'Layouts',
          ['stack', 'cluster', 'grid', 'frame', '*'],
          'Blocks',
          ['field', 'field-grid', 'date-picker', 'time-picker', 'bullet-list', 'checklist', 'interactive-list-item', '*'],
          'Sections',
          ...
          [
            'Sheet',
            ['sheet-typography', 'Read-Mode Sheet', '*'],
            'Form',
            ['Read-Mode Page', '*'],
            '*',
          ],
