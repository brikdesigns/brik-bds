    ...
    const notionRes = await fetch(`${NOTION_API}/pages`, {
      ...
      body: JSON.stringify({
        ...
        properties: {
          ...
          // writable by name), Triage → "Triage Status", and the old `Status`
          // + `Scope` selects were removed. Intake writes the surviving select
          // properties; triage assigns the relations.
