...
- [Foundations / Client Themes](?path=/docs/foundations-theming-layers-client-themes--docs) — how per-client theme CSS is generated
- [Blueprints](?path=/docs/theming-layers-blueprints--docs) — page-layout vocabulary (separate axis from atmosphere)
