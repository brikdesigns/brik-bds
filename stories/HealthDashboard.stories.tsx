...
function HealthDashboard() {
  ...
  return (
    <div style={{ padding: 'var(--padding-xl)', display: 'flex', flexDirection: 'column', gap: 'var(--gap-xl)', maxWidth: 960 }}>
      <div>
        <h1 style={heading}>Health Dashboard</h1>
        <div style={{ fontFamily: 'var(--font-family-body)', fontSize: 'var(--body-sm)', color: 'var(--text-muted)' }}>
      ...
      {h.completeness?.gaps && h.completeness.gaps.length > 0 && (
        <div>
          <h3 style={subheading}>Incomplete Components</h3>
          <CompletenessGrid gaps={h.completeness.gaps} />
        </div>
      )}

      {/* Grid compliance detail */}
      {data.grid?.categories && (
        <div>
          <h3 style={subheading}>Grid Compliance by Category</h3>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--gap-md)' }}>
        {h.bundle && !('error' in h.bundle) && (
          <div>
            <h3 style={subheading}>Bundle Size</h3>
        ...
        {h.deps && (
          <div>
            <h3 style={subheading}>Dependencies</h3>
            <div style={{ ...card, padding: 'var(--padding-sm)' }}>
