...
<Meta title="Foundations/Motion/Tiers/GSAP" />

# GSAP Tier <TierBadge tier="gsap" />

Add GSAP when the design calls for scroll pinning, scroll-scrubbed animations, horizontal scroll panels, or text splitting. Everything from the [Lightweight tier](?path=/docs/foundations-motion-tiers-lightweight--docs) still applies — GSAP adds runtime control on top of CSS effects.
