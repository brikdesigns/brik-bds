...
<Meta title="Foundations/Motion/Overview" />
...
- [Animation Tier](?path=/docs/foundations-motion-vocabulary-animation-tier--docs) — `subtle · moderate · expressive` (single-select)
- [Image Mood](?path=/docs/overview-theming-image-mood--docs) — 6 values, multi-select 1–3
...
- [Scroll Reveals](?path=/docs/foundations-motion-effects-scroll-reveals--docs)
- [Overlays](?path=/docs/foundations-motion-effects-overlays--docs)
- [Design Tokens](?path=/docs/foundations-design-tokens-overview--docs)
- [Content System](?path=/docs/foundations-content-overview--docs)
