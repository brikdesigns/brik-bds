...
- [Image Mood](?path=/docs/foundations-motion-vocabulary-image-mood--docs) — 6 values, multi-select 1–3
...
- [Content System](?path=/docs/foundations-content-system-overview--docs)
