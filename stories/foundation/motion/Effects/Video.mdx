...
<Meta title="Foundations/Motion/Effects/Video" />
...
Video playback tied to scroll position — user scrolls to advance the video frame-by-frame. Requires `premium-scroll.js` and GSAP. See [Premium tier](?path=/docs/foundations-motion-tiers-premium--docs) for the implementation pattern.

## Related

- [Overlays (grain + glass)](?path=/docs/foundations-motion-effects-overlays--docs)
