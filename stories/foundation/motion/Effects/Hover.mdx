...
<Meta title="Foundations/Motion/Effects/Hover" />

# Hover Effects

Micro-interactions for buttons, cards, and links. CSS-only effects are in `css/animations.css` — no JS. Magnetic cursor and cursor trail effects require the [Premium tier](?path=/docs/foundations-motion-tiers-premium--docs).
