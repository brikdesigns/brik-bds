...
<Meta title="Foundations/Motion/Effects/Typography" />
...
For letter-by-letter or word-by-word animated reveals, use GSAP SplitText instead of CSS classes. See [GSAP Tier](?path=/docs/foundations-motion-tiers-gsap--docs) for the splitting pattern.
