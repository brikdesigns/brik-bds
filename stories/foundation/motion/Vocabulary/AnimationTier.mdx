...
<Meta title="Motion/Vocabulary/Animation Tier" />
...
- `subtle` → [Lightweight Tier](?path=/docs/motion-tiers-lightweight--docs)
- `moderate` → [GSAP Tier](?path=/docs/motion-tiers-gsap--docs)
- `expressive` → [Premium Tier](?path=/docs/motion-tiers-premium--docs)
